...
// Rekah activity) and DashboardTier1Context (teacher input) so
...
const ICON_META: Record<ToastKind, { icon: LucideIcon; color: string; bg: string }> = {
  'forum-reply': { icon: MessageSquare, color: 'text-rekah', bg: 'bg-fajar' },
  'webinar-registered': { icon: Video, color: 'text-rekah', bg: 'bg-fajar' },
  'webinar-reminder': { icon: Clock, color: 'text-rekah', bg: 'bg-fajar' },
