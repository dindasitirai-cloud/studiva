...
export default function BandSegera({ label }: Props) {
  return (
    <div className="flex min-h-[40vh] items-center justify-center px-6 py-16">
      ...
      >
        ...
        <p className="mb-1 font-bricolage text-[13px] font-bold uppercase tracking-widest text-rekah/70">
          Segera Hadir
        </p>
        ...
        <p className="text-[15px] leading-relaxed text-pekat/60">
          Beranda {label.toLowerCase()} sedang kami siapkan. Nantikan panduannya, ya.
        </p>
