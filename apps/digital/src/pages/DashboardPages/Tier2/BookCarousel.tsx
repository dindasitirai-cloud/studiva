    ...
    <div className="flex flex-col gap-5">
      ...
      {selected && (
        <div className="text-center">
          <p className="font-bricolage text-[20px] font-extrabold text-stv-navy">{selected.title}</p>
      ...
      <div className="flex flex-col items-center gap-3">
        {selected && getCardContentStatus(selected) === 'segera-hadir' ? (
          <span className="rounded-full bg-slate-200 px-8 py-3 font-bricolage text-[16px] font-bold text-slate-400 cursor-default select-none">
            Segera hadir
          </span>
        ) : (
          <button
            ...
            className="rounded-full bg-amber-500 px-8 py-3 font-bricolage text-[16px] font-bold text-white shadow-[0_6px_20px_rgba(251,146,60,.3)] transition hover:-translate-y-0.5 hover:bg-amber-600"
          >
            Buka buku ini
          </button>
        )}
