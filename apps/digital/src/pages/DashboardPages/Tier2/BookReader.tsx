            ...
            <div style={{ position: 'relative', width: '100%', height: 0, paddingBottom: '130%' }}>
              ...
              <div style={{
                ...
                <div style={{ position: 'absolute', bottom: 0, left: 18, right: 0, padding: '20px 16px', background: 'linear-gradient(to top, rgba(0,0,0,0.8), transparent)', zIndex: 3 }}>
                  ...
                  <p style={{ fontSize: 20, color: 'white', fontWeight: 800, lineHeight: 1.3, fontFamily: "'Bricolage Grotesque', sans-serif" }}>{card.title}</p>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ position: 'absolute', inset: 0, paddingLeft: 18, overflowY: 'auto' }}>
                  <div className="p-4 pb-6">
                    ...
                    <h1 className="mb-3 font-bricolage text-[20px] font-extrabold leading-snug text-stv-navy">{card.title}</h1>
              ...
              <div style={{
                ...
                <div style={{ position: 'absolute', inset: 0, paddingLeft: 18, overflowY: 'auto' }}>
                  <div className="p-4 pb-8">
                    ...
                    <h2 className="mb-1 font-bricolage text-[18px] font-extrabold leading-snug text-stv-navy">{sci.title}</h2>
                    {sci.readMinutes && (
                      ...
                      <div className={`mb-5 grid gap-3 ${sci.stats.length === 2 ? 'grid-cols-2' : 'grid-cols-3'}`}>
                        {sci.stats.map((stat, i) => (
                          <div key={i} className="rounded-xl border border-amber-200 bg-amber-50 p-3 text-center">
                            <p className="font-bricolage text-[22px] font-bold leading-none" style={{ color: '#BA7517' }}>
                              {stat.value}
                        ...
                        {sci.sections!.map((section, idx) => (
                          <React.Fragment key={idx}>
                            <section className="mb-5">
                              <h3 className="mb-1.5 flex items-center gap-2 font-bricolage text-[15px] font-bold text-stv-navy">
                    ...
                    {sci.references && sci.references.length > 0 && (
                      <div className="mt-6 rounded-xl border border-stv-border bg-white p-4">
                        <h4 className="mb-2 font-bricolage text-[14px] font-bold text-stv-navy">Referensi</h4>
