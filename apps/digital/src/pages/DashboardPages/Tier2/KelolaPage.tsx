// KelolaPage — route tersendiri untuk Kelola (Family Operating System).
// Plumbing data identik dengan IramaHariPage (nilai dari Kompas, centang kebiasaan,
// jadwalkan dari Bekal), tetapi merender komponen Kelola dengan IA tab + timetable.
// Additive: tidak mengubah/menghapus IramaHariPage.
...
import KelolaHub from '../../../features/irama-hari/KelolaHub';
