            ...
            <div className="rounded-2xl border border-stv-border bg-gradient-to-br from-slate-50 to-white p-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-bricolage text-[16px] font-bold text-stv-navy">{activeChild.name}</p>
              ...
              <div className="mt-3 grid grid-cols-3 gap-3">
                <div className="rounded-xl bg-white p-3 text-center shadow-sm">
                  <p className="font-bricolage text-[20px] font-bold text-stv-navy">{totalForAge}</p>
                  <p className="text-[11px] leading-tight text-stv-muted">Buku tersedia</p>
                </div>
                <div className="rounded-xl bg-white p-3 text-center shadow-sm">
                  <p className="font-bricolage text-[20px] font-bold text-stv-green">{readCount}</p>
                  <p className="text-[11px] leading-tight text-stv-muted">Sudah dibaca</p>
                </div>
                <div className="rounded-xl bg-white p-3 text-center shadow-sm">
                  <p className="font-bricolage text-[20px] font-bold text-amber-500">{savedCount}</p>
