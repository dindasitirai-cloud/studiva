...
exports.CARDS = exports.SUMMARY_LABEL_STYLES = exports.DOMAIN_MAP = exports.AGE_RANGES = exports.getCardContentStatus = void 0;
const domains_1 = require("./domains");
function getCardContentStatus(card) {
    if (!card.summary)
        return 'segera-hadir';
    const hasSections = (card.scientific.sections?.length ?? 0) > 0 ||
        (card.scientific.paragraphs?.length ?? 0) > 0;
    return hasSections ? 'lengkap' : 'ringkasan-saja';
}
exports.getCardContentStatus = getCardContentStatus;
exports.AGE_RANGES = [
...
exports.DOMAIN_MAP = Object.fromEntries(domains_1.DOMAIN_CONFIGS.map(d => [d.code, { label: d.label, icon: d.icon, bg: d.bg, fg: d.fg }]));
exports.SUMMARY_LABEL_STYLES = {
...
const P = (id, alt, credit = "Unsplash") => ({ src: `/images/rl/${id}.jpg`, alt, credit });
exports.CARDS = [
...
//# sourceMappingURL=knowledgeCardData.js.map