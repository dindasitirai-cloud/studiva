...
exports.getAgeBand = exports.AGE_BANDS = void 0;
exports.AGE_BANDS = [
    {
        id: '0-6',
        label: '0–6 Bulan',
...
function getAgeBand(bulan) {
    return exports.AGE_BANDS.find(b => bulan >= b.minBulan && bulan <= b.maxBulan);
}
exports.getAgeBand = getAgeBand;
//# sourceMappingURL=ageBands.js.map