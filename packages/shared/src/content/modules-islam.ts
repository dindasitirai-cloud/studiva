 ...
 */
export const ISLAMIC_PANELS: Record<AgeKey, IslamicPanel> = {

  // Band 1 · 0–3 bulan — "Sambutan Iman"
  '0-3m': {
    nilaiInti: 'Asosiasi pertama antara rasa aman dan suasana keimanan',
    sains:
      'Bayi baru lahir mengenali suara orang tuanya sejak dalam kandungan, dan respons konsisten terhadap tangisan membangun kelekatan aman — fondasi seluruh perkembangan empati dan nilai di masa depan.',
    islam:
      'Islam menyambut bayi dengan bunyi: adzan dan iqamah di telinga, tahnik, lalu aqiqah. Kalimat pertama yang didengar bayi adalah kalimat tauhid — simbol bahwa iman hadir sejak hari pertama, dalam suasana kasih.',
    praktik: [
  ...
  '3-6m': {
    ...
    sains:
      'Bayi usia ini mulai membedakan nada emosi dan menoleh ke sumber suara; rutinitas yang dapat diprediksi menurunkan stres dan mendukung regulasi diri awal.',
    islam:
      'Lantunan Al-Qur\'an dan doa harian orang tua menjadi "soundtrack rumah" — anak menyerap suasana sebelum makna. Suara orang tua yang membaca sendiri lebih berharga daripada audio, karena membawa kehangatan relasi.',
    praktik: [
  ...
  '6-9m': {
    ...
    sains:
      'Bayi mulai mengamati dan mengingat rutinitas orang di sekitarnya; kebiasaan yang dilihat berulang terekam sebagai "normal"-nya dunia.',
    islam:
      'Keteladanan (qudwah) dimulai jauh sebelum anak bisa diajari. Bayi yang setiap hari melihat orang tuanya shalat, mendengar bismillah sebelum makan dan salam di pintu, sedang menyerap kurikulum iman tanpa satu pun instruksi.',
    praktik: [
  ...
  '9-12m': {
    ...
    sains:
      'Joint attention berkembang pesat di usia 9–12 bulan — bayi mengikuti arah pandang dan tunjukan orang tua, lalu belajar bahwa yang diperhatikan orang tuanya adalah hal penting.',
    islam:
      'Inilah jendela untuk "menunjukkan" iman: mengangkat tangan saat berdoa sambil menatap anak, menunjuk bulan sambil berkata "Ciptaan Allah, indah ya" — anak belajar bahwa Allah adalah bagian dari hal-hal yang dianggap penting keluarganya.',
    praktik: [
  ...
  '12-18m': {
    ...
    sains:
      'Anak usia ini belajar hampir seluruhnya lewat meniru, dan riset menunjukkan imitasi responsif balita memprediksi tumbuhnya hati nurani di usia prasekolah. Empati primitif sudah muncul sejak 14 bulan.',
    islam:
      'Anak yang ikut sujud di samping orang tua sedang menjalani "pendidikan shalat" terbaik untuk usianya. Nabi ﷺ membiarkan cucunya menaiki punggung beliau saat sujud — ibadah dan kelembutan pada anak tidak pernah dipertentangkan.',
    praktik: [
  ...
  '18-24m': {
    ...
    sains:
      'Ledakan bahasa dimulai — frasa pendek berulang mudah diserap. Di usia ini anak juga sudah mampu perilaku menolong dan menghibur sederhana; apresiasi spesifik memperkuatnya.',
    islam:
      'Pembiasaan (ta\'wid) doa sebelum makan dan tidur — bukan untuk hafal sempurna, tapi agar doa terasa bagian alami aktivitas. Adab makan dengan tangan kanan diperkenalkan dengan lembut, tanpa drama.',
    praktik: [
  ...
  '2-3y': {
    ...
    sains:
      'Kehangatan pengasuh membentuk cara anak membayangkan figur otoritas — termasuk konsep Tuhan. Percakapan tentang perasaan mempercepat empati, dan cerita moral positif efektif menanamkan kejujuran sejak usia sangat dini.',
    islam:
      'Ma\'rifatullah dimulai dari cinta: perkenalkan Allah lewat Ar-Rahman dan Ar-Rahim — Allah yang memberi hujan, menciptakan kucing lucu, menyayangi anak. "Siapa mengenal Allah akan mencintai-Nya; siapa mencintai Allah akan menaati-Nya" — cinta dulu, taat kemudian.',
    praktik: [
  ...
  '3-4y': {
    ...
    sains:
      'Metode kisah sangat membekas dalam ingatan anak dan efektif membentuk karakter; praktik syukur sejak dini meningkatkan resiliensi emosional dan pandangan hidup positif.',
    islam:
      'Kisah Nabi dan orang shalih adalah kurikulum akhlak utama usia ini — satu kisah, satu sifat baik. Syukur ditanam sebagai cara melihat dunia: alhamdulillah bukan sekadar ucapan sopan, tapi respons hati.',
    praktik: [
  ...
  '4-5y': {
    ...
    sains:
      'Regulasi diri menguat tapi konsentrasi masih pendek — anak di bawah 7 tahun banyak bergerak dan sulit diam, sehingga latihan ibadah formal memang belum waktunya. Paksaan dini berisiko membentuk asosiasi negatif dengan ibadah.',
    islam:
      'Fase mahabbatullah: menumbuhkan cinta sebelum kewajiban. Para ulama sengaja menempatkan "usia perintah" di 7 tahun — sebelum itu, ajakan bersifat sukarela dan gembira. Hafalan Al-Fatihah dan surat pendek dimulai lewat lagu dan permainan.',
    praktik: [
  ...
  '5-6y': {
    ...
    sains:
      'Motorik halus dan kemampuan mengikuti urutan langkah (sequencing) sudah cukup matang untuk wudhu; identitas moral mulai terbentuk. Latihan bertahap dengan scaffolding jauh lebih efektif daripada tuntutan langsung sempurna.',
    islam:
      '"Perintahkanlah anak kalian shalat ketika berumur tujuh tahun" (HR Abu Dawud) — perintah yang ditujukan kepada orang tua untuk melatih dengan sabar (QS Thaha: 132), bukan kewajiban di pundak anak. Puasa dikenalkan bertahap — puasa "sampai dzuhur" adalah latihan yang sah secara pedagogis.',
    praktik: [
